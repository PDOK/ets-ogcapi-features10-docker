...
def get_api_docs_url(test_xml_name, name):
    return f'https://cite.opengeospatial.org/te2/about/ogcapi-features-1.0/1.0/site/apidocs/index.html?{test_xml_name.replace(".","/")}.html ({name})'
...
def main(result_dir, service_url, pretty_print, exit_on_fail):
    ...
    if pretty_print:
        console.print(
            "ogcapi-features-1.0-1.4 Test Suite Run",
        ...
        console.print("# ogcapi-features-1.0-1.4 Test Suite Run\n")
